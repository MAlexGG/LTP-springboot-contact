...
@Tag(name = "Contact Controller", description = "Manage contacts")
@RestController
public class ContactController {
    ...
    @Operation(summary = "Update contact by id", description = "Update a contact based on an id")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "201", description = "Successful edition of contact"),
        @ApiResponse(responseCode = "400", description = "Bad request: unsuccessful submission", content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
    })
    ...
    @Operation(summary = "Delete contact by id", description = "Delete a contact based on an id")
    @ApiResponses(value = {
